namespace PetClinic.DataProcessor
{
    ...
    public class Serializer
    {
        ...
        {
            var animal = context.Animals.Where(a => a.Passport.OwnerPhoneNumber == phoneNumber)
                .Select(ai => new AnimalDto
                {
                    ...
                    RegisteredOn = ai.Passport.RegistrationDate.ToString("dd-MM-yyyy", CultureInfo.InvariantCulture)
                })
                .OrderBy(a => a.Age)
