    ...
    public class ModifyUserCommand : ICommand
    {
        ...
        public string Execute(string[] data)
        {
            ...
            switch (property)
            {
                ...
                case "CurrentTown":
                    ...
                    break;
                default:
                    throw new ArgumentException(string.Format(PropertyNotFound, property));
            }

            return string.Format(SuccessfullyModifiedUser, username, property, newValue);
        }
        ...
        private void ValidateTown(string townName)
        {
            if (!this.townService.Exists(townName))
            {
                ...
                throw new ArgumentException(string.Format(InvalidValue, townName, detailedMessage));
            }
        }
        ...
        private void ValidatePassword(string newPassword)
        {
            ...
            if (!Regex.IsMatch(newPassword, pattern))
            {
                ...
                throw new ArgumentException(string.Format(InvalidValue, newPassword, detailedMessage));
