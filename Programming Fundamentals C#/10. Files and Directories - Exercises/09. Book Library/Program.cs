namespace _09._Book_Library
{
    ...
    public class Program
    {
        ...
        public static void TitlesAfterDate(Library library)
        {
            ...
            File.WriteAllLines("../../../IO/Titles after given date.txt", result.Select(x => $"{x.Key} -> {x.Value:dd.MM.yyyy}"));
        }

        public static Dictionary<string, DateTime> TitleDate(Library library)
        {
            // day.month.year
            DateTime initialDate = DateTime.ParseExact(File.ReadAllText("../../../IO/Date.txt"), "d.M.yyyy", CultureInfo.InvariantCulture);
        ...
        private static void AuthorAndSumOfPrices(Library library)
        {
            ...
            File.WriteAllLines("../../../IO/Authors by Prices.txt", authorByPrices.Select(x => $"{x.Key} -> {x.Value:F2}"));
        }
        ...
        private static Library CreateLibrary()
        {
            ...
            string[] booksData = File.ReadAllLines("../../../IO/Books Data.txt");
